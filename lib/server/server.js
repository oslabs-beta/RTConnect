const ws = require('ws');
const { OFFER, ANSWER, ICECANDIDATE, LOGIN } = require('../src/constants/actions.js');
...
class SignalingChannel {
    constructor(httpsServer) { //no config defined yet, just passing in a server (https, app), can pass in port too (not the same port)
    this.webSocketServer = new ws.Server(httpsServer)
