...
describe('WebSocket checks', () => {
  describe('WebSocket invalid url checks', () => {
    ...
    //   expect(() => ws.host.toMatch('localhost'));
  ...
  // Determine with team which checks are needed
  /*
  describe('Constants', () => {
    const readyStates = {
      CONNECTING: 0,
  ...
  */
  ...
  // Next set of tests to implement
  /*
  ...
  */
  ...
  // Determine with team which tests
  /*
  describe('#terminate', () => {
